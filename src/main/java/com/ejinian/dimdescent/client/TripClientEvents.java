...
public final class TripClientEvents {
    ...
    // Attunement and Delirium each apply a real vanilla effect under the hood to borrow its
    ...
    public static void onRegisterClientExtensions(RegisterClientExtensionsEvent event) {
        ...
        event.registerMobEffect(hiddenWhile(ModRegistry.DELIRIUM_EFFECT), MobEffects.NIGHT_VISION.value());
